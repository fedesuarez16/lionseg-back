  ...
  app.post('/api/generar-facturas', async (req, res) => {
    try {
      ...
      for (const cliente of clientes) {
        ...
        expirationDate.setDate(invoiceDate.getDate() + 7);
        ...
        // Descargar la imagen QR y agregarla en la parte inferior centrado
        ...
        const qrImageResponse = await axios.get(qrImageURL, { responseType: 'arraybuffer' });
        const qrImageBuffer = Buffer.from(qrImageResponse.data, 'binary');
        const qrImageWidth = 100;
        doc.image(qrImageBuffer, (doc.page.width - qrImageWidth) / 2, doc.page.height - 150, { width: qrImageWidth });
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd;">
          ...
          <p style="text-align: center;">
            <a href="${facturaLink}" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">Descargar Factura</a>
          </p>
