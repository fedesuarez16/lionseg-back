    ...
    if (invoiceLink.state !== 'paid' && state === 'paid') {
      ...
      emailHtml = `
       <div style="font-family: Arial, sans-serif; font-size: 16px; color: #333;">
        <img src="https://storage.cloud.google.com/lionseg/logolionseg.png" alt="Logo de tu empresa" style="width: 150px;"/>
